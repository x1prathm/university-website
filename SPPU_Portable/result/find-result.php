...
<html lang=\"en\">
    ...
    <body class=\"\">
        <div class=\"main-wrapper\">
            ...
            <div style=\"background-color:#5C5ADB;\" class=\"login-bg-color\">
                <div class=\"row\">
                            ...
                            <div class=\"panel-body p-20\">
                                ...
                                <form action=\"result.php\" method=\"post\">
                                	<div class=\"form-group\">
                                        ...
                                        <input type=\"text\" class=\"form-control\" id=\"rollid\" name=\"rollid\" placeholder=\"Enter Your Roll Id\" autocomplete=\"off\" required=\"required\">
                                	</div>
                               <div class=\"form-group\">
                                    ...
                                    <select name=\"class\" class=\"form-control\" id=\"default\" required=\"required\">
                                        ...
                                        foreach ($classes as $c) {
                                            ...
                                            $section = htmlspecialchars($c['section']);
                                            echo "<option value=\"{$id}\">Class-{$name} Section-{$section}</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
